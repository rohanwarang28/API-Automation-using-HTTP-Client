...
public class ApiTests extends TestBase {
	...
	@Test(priority=1)
	public void getResponseWithoutHeaders() throws ClientProtocolException, IOException {
	...
	@Test(priority=2)
	public void getResponseWithHeaders() throws ClientProtocolException, IOException {
		restClient=new RestClient();
		...
		httpResponse=restClient.get(serviceUrl+apiUrl, headerMap);
